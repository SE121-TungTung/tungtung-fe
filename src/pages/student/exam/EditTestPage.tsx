...
export default function EditTestPage() {
    ...
    useEffect(() => {
        if (originalTest) {
            setTitle(originalTest.title)
            setDescription(originalTest.description || '')
            setInstructions(originalTest.instructions || '')
            setTestType(originalTest.testType)
            setTimeLimitMinutes(originalTest.timeLimitMinutes || 60)
            setPassingScore(originalTest.passingScore)
            setMaxAttempts(originalTest.maxAttempts)
            setRandomizeQuestions(originalTest.randomizeQuestions)
            setShowResultsImmediately(originalTest.showResultsImmediately)
            setAiGradingEnabled(originalTest.aiGradingEnabled)
            setStartTime(originalTest.startTime || '')
            setEndTime(originalTest.endTime || '')
        }
    }, [originalTest])
    ...
    const getQuestionTypeLabel = (type: QuestionType): string => {
        const questionTypeGroups = {
            'Reading & Listening': [
                ...
                {
                    value: QuestionType.DIAGRAM_LABELING,
    ...
    const isDraft = originalTest?.status === TestStatus.DRAFT

    // ========================================
    // Render (same as CreateTestPage)
    // ========================================
    return (
        <div className={s.container}>
            <div className={s.layout}>
                ...
                />
                <div className={s.content}>
                    <h1 className={s.pageTitle}>Chỉnh sửa bài thi</h1>
                        ...
                        >
                            ...
                            >
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    >
                                        Học sinh chưa thể thấy bài thi này. Nhấn
                                        "Xuất bản" để công khai.
                                    </p>
                                </div>
                            </div>
                        </Card>
                    ...
                    {/* SECTIONS - Same structure as CreateTestPage */}
                    {sections.map((section, sIndex) => (
                        ...
                        >
                            ...
                            {/* PARTS - Reuse same logic as CreateTestPage */}
                            {section.parts.map((part, pIndex) => (
                                ...
                                >
                                    {/* Same form fields as CreateTestPage for parts */}
                                    <div
                                    ...
                                    >
                                        ...
                                        {/* Audio/Image upload - same as CreateTestPage */}
                                        {section.skill_area ===
                                            SkillArea.LISTENING && (
                                    ...
                                    {/* QUESTION GROUPS - Same as CreateTestPage */}
                    ...
                    <div className={s.actions}>
                        ...
                        {isDraft && (
                            <ButtonPrimary
                                ...
                                loading={submittingStatus === 'publishing'}
                                disabled={submittingStatus !== 'idle'}
                                variant="gradient"
                            >
                                🚀 Xuất bản
